    ...
    return (
        <>
            ...
            >
                ...
                <Layout style={ styles.infoColThree }>
                    <Text style={ [ styles.text, styles.lightText, styles.leftAlignedText ] }>Vietnxamese</Text>
                </Layout>
            </Layout>

            <Layout style={ styles.versionBox } >
                <Text style={ [ styles.text, styles.leftAlignedText, styles.smallerText ] }>
                    Currently only English dictionary and Vietnamese translations are available. More languages are coming soon.
                </Text>
            </Layout>
